...
const navigateState = {
  state: {
    title: 'Thank you',
    subtitle:
      "You're officially subscribed to the Polish Notes monthly newsletter! Please check your inbox to confirm the subscription 💌",
    actionOne:
      'Check out our shop with worksheets and listening practice, you can also claim some for free!',
    buttonOne: 'Worksheets',
    actionTwo:
      'Book a private online lesson or conversation practice with one of us',
    buttonTwo: 'Choose teacher',
    actionThree:
      'Watch our Polish Grammar Cases Explained playlist to begin your learning process',
